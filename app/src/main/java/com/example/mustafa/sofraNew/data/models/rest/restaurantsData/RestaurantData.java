...
public class RestaurantData {
    ...
    @Expose
    private List<GeneralResposneData> categories = null;
    ...
    public List<GeneralResposneData> getCategories() {
        return categories;
    }
    public void setCategories(List<GeneralResposneData> categories) {
