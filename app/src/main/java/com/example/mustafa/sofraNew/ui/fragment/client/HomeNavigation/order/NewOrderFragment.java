...
public class NewOrderFragment extends Fragment {
    ...
    @BindView(R.id.Fragment_client_new_order_recycler)
    RecyclerView FragmentClientNewOrderRecycler;
    Unbinder unbinder;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_new_user_order, container, false);
    ...
    private void setupRecycler() {
        ...
        HelperMethods.setInitRecyclerViewAsLinearLayoutManager(getActivity(), FragmentClientNewOrderRecycler,manager);
            ...
            public void onResponse(Call<ListOfOrders> call, Response<ListOfOrders> response) {
                ...
                try {
                    if (response.body().getStatus()==1) {
                        ...
                        FragmentClientNewOrderRecycler.setAdapter(adapter);
